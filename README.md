...
Computer Vision (ORB): Uses Oriented FAST and Rotated BRIEF (ORB) feature matching for shape and symbol classification.

Multi-threaded Integration: High-level synchronization of vision and motion sub-processes.

Hardware Interface: GPIO control of L298N motor drivers for precise wheel movement.
